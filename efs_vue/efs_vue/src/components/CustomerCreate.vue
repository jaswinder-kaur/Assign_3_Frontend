            ...
            <v-card class="login-card">
              ...
              <v-card-text>
                <v-form ref="form" lazy-validation>
                  ...
                  <v-btn v-if="!isUpdate" class="green white--text" @click="createCustomer">Save</v-btn>
                  <v-btn v-if="isUpdate" class="green white--text" @click="updateCustomer">Update</v-btn>
