            ...
            <v-card class="login-card">
              ...
              <v-card-text>
                <v-form ref="form" lazy-validation>
                  ...
                  <v-btn v-if="!isUpdate" class="green white--text" @click="createInvestment">Save</v-btn>
                  <v-btn v-if="isUpdate" class="green white--text" @click="updateInvestment">Update</v-btn>
